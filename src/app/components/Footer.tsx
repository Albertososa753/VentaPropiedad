        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              Casa en venta por dueño directo. Excelente oportunidad de inversión en zona tranquila y residencial.
            </p>
            ...
            <div className="contact-items">
              <div className="contact-item">
                ...
                <div className="contact-details">
                  ...
                  <span className="contact-value">Pringles al 100, San Nicolás</span>
                </div>
              </div>
              <div className="contact-item">
          ...
          <div className="footer-bottom-content">
            <div className="copyright">
              <p className="copyright-text">
                © {currentYear} Venta de Propiedad en San Nicolás de los Arroyos
              </p>
              <p className="copyright-subtext">Zona Céntrica | Dueño Directo | Sin Intermediarios</p>
            </div>
            <div className="footer-badge">
              <span className="badge-text">Dueño Directo</span>
            </div>
          </div>
        </div>
      </div>
