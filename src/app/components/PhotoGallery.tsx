        ...
        <div className="main-image-container-modern">
          <div className="image-wrapper">
            <Image
              ...
              width={800}
              height={500}
              className={`main-gallery-image-modern ${imageLoaded ? "loaded" : ""}`}
            ...
            {/* Expand button */}
            <button className="expand-button" onClick={() => openModal(currentIndex)}>
              <Maximize2 size={18} />
            </button>
          </div>
        ...
        <div className="thumbnails-container-modern">
          <div className="thumbnails-scroll">
            {images.map((image, index) => (
              <div
                key={index}
                className={`thumbnail-modern ${index === currentIndex ? "active" : ""}`}
                onClick={() => {
                  setCurrentIndex(index)
                  setImageLoaded(false)
                }}
        ...
        <div className="modal-overlay-modern" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content-modern" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close-modern" onClick={() => setIsModalOpen(false)}>
                <X size={24} />
              </button>
            </div>
